...
class _WorkTasksState extends State<WorkTasks> {
  ...
  void initState() {
    ...
    FirebaseService.getCurrentUser_work_completed_todotasks().then(
      (todoIds) {
        context
            .read<TodotaskProvider>()
    ...
    FirebaseService.getCurrentUser_work_not_completed_todotasks().then(
      (todoIds) {
        context
            .read<TodotaskProvider>()
            ...
            isclicked == false
                    ...
                    child: StatefulBuilder(
                      ...
                      return Consumer<TodotaskProvider>(
                        ...
                        context
                            ...
                            .getOnlyCurrectusers_work_not_completed_ToDoTasks();
                        List<ToDoTask?>
                            allcurrentUser_work_not_completed_ToDoTasks =
                            todotasks.currentUser_work_not_complete_todotasks;
                        print(
                            "Len of all not work task: ${allcurrentUser_work_not_completed_ToDoTasks.length}");
                        return allcurrentUser_work_not_completed_ToDoTasks
                                .isEmpty
                            ? showContainer1 == true
                                ? Center(
                                    child: SpinKitWave(
                ...
                : Expanded(
                    ...
                    child: Consumer<TodotaskProvider>(
                      ...
                      List<ToDoTask?> allcurrentUser_work_completed_ToDoTasks =
                          todotasks.currentUser_work_completed_todotasks;
                      print(
                          "Len of all work completed task: ${allcurrentUser_work_completed_ToDoTasks.length}");
                      return allcurrentUser_work_completed_ToDoTasks.isEmpty
                          ? showContainer2 == true
                              ? Center(
                                  child: SpinKitWave(
                                  color: Colors.lightBlue,
                          ...
                          : ListView.builder(
                              controller: _scrollController,
                              itemCount: allcurrentUser_work_completed_ToDoTasks
                                  .length,
                              scrollDirection: Axis.vertical,
                              itemBuilder: (context, int index) {
                                return AnimatedContainer(
                                  ...
                                  child: ToDoListCardCompleted(
                                    ...
                                    ToDoTaskData:
                                        allcurrentUser_work_completed_ToDoTasks[
                                            index]!,
                                  ),
                                );
                              },
