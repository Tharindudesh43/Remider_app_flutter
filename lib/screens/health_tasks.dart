...
class _HealthTasksState extends State<HealthTasks> {
  ...
  void initState() {
    ...
    FirebaseService.getCurrentUser_health_completed_todotasks().then(
      (todoIds) {
        context
            .read<TodotaskProvider>()
    ...
    FirebaseService.getCurrentUser_health_not_completed_todotasks().then(
      (todoIds) {
        context
            .read<TodotaskProvider>()
        ...
        appBar: AppBar(
          ...
          title: Text(
            ...
            style: GoogleFonts.permanentMarker(
                fontSize: 21, color: Colors.pink, fontWeight: FontWeight.w500),
          ),
        ),
        body: Column(
          children: [
            ...
            isclicked == false
                    ...
                    child: StatefulBuilder(
                      ...
                      return Consumer<TodotaskProvider>(
                        ...
                        context
                            ...
                            .getOnlyCurrectusers_health_not_completed_ToDoTasks();
                        List<ToDoTask?>
                            allcurrentUser_health_not_completed_ToDoTasks =
                            todotasks.currentUser_health_not_complete_todotasks;
                        print(
                            "Len of all not health task: ${allcurrentUser_health_not_completed_ToDoTasks.length}");
                        return allcurrentUser_health_not_completed_ToDoTasks
                                .isEmpty
                            ? showContainer1 == true
                                ? Center(
                                    child: SpinKitWave(
                ...
                : Expanded(
                    ...
                    child: Consumer<TodotaskProvider>(
                      ...
                      List<ToDoTask?>
                          allcurrentUser_health_completed_ToDoTasks =
                          todotasks.currentUser_health_completed_todotasks;
                      print(
                          "Len of all health completed task: ${allcurrentUser_health_completed_ToDoTasks.length}");
                      return allcurrentUser_health_completed_ToDoTasks.isEmpty
                          ? showContainer2 == true
                              ? Center(
                                  child: SpinKitWave(
                                  color: Colors.pink,
